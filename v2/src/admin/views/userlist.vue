<template>
  <div>
    ...
    <el-table :data="tableData" stripe height="82vh" border >
      ...
      <el-table-column label="每日一清" width="300">
        <template slot-scope="scope" v-if="scope.row.todoData">
      ...
      <el-table-column label="权限">
        <template slot-scope="scope">
          ...
          <!-- 0 -->
          <el-tag type="info" v-if="scope.row.power[0] == 0">
            用户
          </el-tag>
          ...
          <el-tag type="danger" v-else v-for="item in scope.row.power" :key="item.p">
            {{item}}
          </el-tag>
      ...
      <el-table-column label="最新登录" width="180">
        <template slot-scope="scope">
